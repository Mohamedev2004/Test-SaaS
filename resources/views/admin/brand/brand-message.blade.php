        ...
        <div class="dash__content">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full border-collapse border border-gray-300 mt-6">
                    ...
                    <tbody>
                        @forelse ($brandMessages as $message)
                        <tr class="hover:bg-gray-100">
                            <td class="border border-gray-300 px-4 py-2">{{ $message->user->name }}</td> <!-- Brand Name -->
                            <td class="border border-gray-300 px-4 py-2">{{ $message->influencer->influencerName}}</td> <!-- Influencer Name -->
